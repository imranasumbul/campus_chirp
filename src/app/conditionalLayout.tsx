    ...
    <>
      <Toaster />
        ...
        <div className="min-h-screen overflow-y-auto bg-dark-bg max-w-screen text-dark-text ">
          <div className="container overflow-hidden xl:px-30 h-screen mx-auto max-w-6xl">
              <div className="grid grid-cols-4 h-full pt-4">
                <Sidebar />
                <div className="col-span-3 lg:col-span-2 overflow-hidden border-x-[2px] border-neutral-700">
                  {children}
                </div>
                <FollowBar/>
